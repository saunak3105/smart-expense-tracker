...
import { Wallet, Lock, User, Mail, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto mt-20">
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Join SmartExpense and start tracking</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary-600 text-white py-3 rounded-xl font-bold hover:bg-primary-700 transition-colors shadow-lg shadow-primary-200 disabled:opacity-50 flex justify-center items-center mt-6"
          >
            {loading ? (
